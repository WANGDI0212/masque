...
if [ $# -ne 6  ]
then
    echo "$0 <reads_dir> <output_dir> <project-name> <nb_cpu> <email> <queue>"
    exit
fi
...
/bin/bash $SCRIPTPATH/masque.sh -i $1/ -o $2/ -n $3 -t $4 --minoverlap 10 --maxoverlap 550 -b -f &> $2/${3}_stat_process.txt
""">$PBS_SCRIPT
