...
if [ $# -ne 7  ]
then
    echo "Usage: $0 <reads_dir> <output_dir> <contaminants> <project-name> <nb_cpu> <email> <queue>"
...
/bin/bash $SCRIPTPATH/masque.sh -i $readdir/ -o $outdir/ -n $4 -t $5 -l -c $3 &> $outdir/${4}_stat_process.txt || exit 1
